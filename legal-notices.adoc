...
* link:media/notice-aws.pdf["Aviso para o mediador do Cloud Volumes ONTAP 9.14.0 na AWS"^]
* link:media/notice-google-cloud.pdf["Aviso para o mediador do Cloud Volumes ONTAP 9.14.0 no Google Cloud"^]
